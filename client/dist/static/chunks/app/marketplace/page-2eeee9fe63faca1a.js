...
function MarketplacePage() {
    ...
    const handleRetry = async ()=>{
        const fetchMaterials = async ()=>{
            try {
                ...
                const response = await fetch("https://recycling-marketplace-backend.onrender.com/api/materials?t=".concat(timestamp), {
                    cache: "no-store",
                    headers: {
                ...
                if (!response.ok) {
                    ...
                    console.error("MarketplacePage: API request failed with status ".concat(response.status, ": ").concat(errorText));
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        ...
        children: [
            ...
            apiResponse && /*#__PURE__*/ (0,jsx_runtime.jsxs)(ui_alert/* Alert */.bZ, {
                className: "mb-4",
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(circle_alert/* default */.Z, {
                        className: "h-4 w-4"
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(ui_alert/* AlertTitle */.Cd, {
...
/******/ __webpack_require__.O(0, [9247,4766,7876,5176,7600,117,1860,813,2971,7023,1744], function() { return __webpack_exec__(6282); });
